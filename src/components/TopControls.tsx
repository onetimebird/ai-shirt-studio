      ...
      <div className="hidden md:flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Button 
            variant="glass" 
            size="default" 
            className="relative overflow-hidden hover:before:absolute hover:before:inset-0 hover:before:bg-gradient-to-r hover:before:from-transparent hover:before:via-gray-300/30 hover:before:to-transparent hover:before:-translate-x-full hover:before:animate-[shimmer_0.8s_ease-in-out] hover:shadow-lg hover:scale-105 transition-all duration-300"
          >
