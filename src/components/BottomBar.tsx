    ...
    <div className="sticky bottom-0 bg-gradient-card border-t border-border px-4 py-4 shadow-glass backdrop-blur-sm z-40">
      ...
      <div className="hidden md:flex items-center justify-between gap-4 lg:gap-6">
        ...
        <div className="flex items-center gap-4 lg:gap-6">
          ...
          <div className="flex items-center gap-2">
            <img src="/icons/tshirt.svg" className="w-4 h-4 text-muted-foreground icon-hover flex-shrink-0 dark:filter dark:brightness-0 dark:invert" alt="T-Shirt" />
          ...
          {/* Color Picker */}
          <div className="flex items-center gap-2">
            <img src="/icons/swatch.png" className="w-5 h-5 text-muted-foreground icon-hover flex-shrink-0 dark:filter dark:brightness-0 dark:invert" alt="Color Swatch" />
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <img src="/icons/save.png" className="w-5 h-5 mr-2 dark:filter dark:brightness-0 dark:invert" alt="Save" />
            Save Design
          </Button>
          ...
          >
            <img src="/icons/long-arrow-right.png" className="w-12 h-8 mr-3 dark:filter dark:brightness-0 dark:invert" alt="Next Step" />
            Next Step
          </Button>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-3 md:hidden">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <img src="/icons/save.png" className="w-4 h-4 mr-2 dark:filter dark:brightness-0 dark:invert" alt="Save" />
            Save
          </Button>
