...
export const UndoRedoControls = () => {
  ...
  return (
    <div className="absolute top-4 left-4 z-[50] flex items-center gap-1.5 md:gap-2 bg-background/90 backdrop-blur-sm border border-border rounded-lg p-1.5 md:p-2 shadow-lg">
