...
export const ProductCanvas = ({ selectedColor, currentSide, selectedProduct, onCanvasReady }: ProductCanvasProps) => {
  ...
  useEffect(() => {
    ...
    FabricImage.fromURL(imageUrl, {
      ...
      // Keep mobile unchanged at 1.05, but make desktop much larger (1.05 is 50% larger than 0.7)
      const scaleFactor = isMobile ? 1.05 : 1.05;
          ...
          <>
            ...
            <div
              style={{
                ...
                height: `${(tshirtDimensions.height * tshirtDimensions.scale * 0.55) / (fabricCanvas?.height || 1) * 100}%`,
            ...
            <div
              style={{
                ...
                height: `${(tshirtDimensions.height * tshirtDimensions.scale * 0.14) / (fabricCanvas?.height || 1) * 100}%`,
            ...
            <div
              style={{
                ...
                height: `${(tshirtDimensions.height * tshirtDimensions.scale * 0.40) / (fabricCanvas?.height || 1) * 100}%`,
                border: window.innerWidth >= 768 ? '2px dashed #60a5fa' : '1px dashed #60a5fa',
                transform: 'translateX(-50%)',
                zIndex: 98,
                pointerEvents: 'none',
