...
serve(async (req) => {
  ...
  try {
    ...
    const enhancedPrompt = `${prompt}, 100% white background, no text, vector graphic style, single image, centered, cropped, isolated on white background, no borders, one subject`
